...
order (adding zeroes to fit it to a 4-digit number), and subtract the smaller number from the bigger number. 
...
the number of times this routine must be performed until 6174 is reached. For example: if num is 3524 your program 
should return 3 because of the following steps: (1) 5432 - 2345 = 3087, (2) 8730 - 0378 = 8352, (3) 8532 - 2358 = 6174. 
...
class Main {  
    public static int KaprekarsConstant(int num) { 
		...
		while( num != 6174){
			...
			int bigger = Integer.parseInt(new StringBuilder(String.valueOf(numDigits)).reverse().toString());
			int smaller = Integer.parseInt(String.valueOf(numDigits));
			num = bigger - smaller;
			counter++;
		}
		return counter;
