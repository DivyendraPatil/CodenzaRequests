# To Run:
# ./info_extract.py documents/1.txt documents/2.txt documents/3.txt documents/4.txt documents/5.txt documents/6.txt documents/7.txt documents/8.txt documents/9.txt
